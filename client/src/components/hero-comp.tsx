...
import { Leaf, Repeat, Monitor, Recycle, Trash, User } from "lucide-react";
...
export default function AnimatedBeamComp() {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-lg p-10 w-full flex flex-row justify-center"
      ref={containerRef}
    >
      <div className="flex size-full flex-col min-w-lg max-w-lg max-h-[200px] items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref}>
            <Repeat className="text-[#226f54] w-8 h-8" />
          </Circle>
          <Circle ref={div5Ref}>
            <Monitor className="text-[#226f54] w-8 h-8" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref}>
            <Leaf className="text-[#226f54] w-8 h-8" />
          </Circle>
          <Circle ref={div4Ref} className="size-16">
            <span className="font-bold text-[#ffffff] bg-[#226f54] rounded-full px-4 py-2">
              V
            </span>
          </Circle>
          <Circle ref={div6Ref}>
            <Recycle className="text-[#226f54] w-8 h-8" />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref}>
            <User className="text-[#226f54] w-8 h-8" />
          </Circle>
          <Circle ref={div7Ref}>
            <Trash className="text-[#226f54] w-8 h-8" />
          </Circle>
        </div>
      </div>
